/* globals module */
/* eslint quotes:[ 2,"double" ], quote-props:[ 2,"always" ] */
...
module.exports = {
  ...
  "rules": {
    ...
    "no-div-regex": 2,
    "no-else-return": 2,
    // disabled in favor of no-labels
    "no-empty-label": 0,
    // disabled in favor of eqeqeq "allow-null"
    "no-eq-null": 0,
    "no-eval": 2,
    ...
    "semi": [ 2, "always" ],
    "sort-vars": 0,
    // Re-enable eslint/eslint//3226 is fixed
